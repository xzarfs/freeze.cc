...
namespace signatures
{
	...
	const DWORD dwEntityList = 0x4DA0D54;
	const DWORD dwForceAttack = 0x31D22C0;
	const DWORD dwForceAttack2 = 0x31D22CC;
	const DWORD dwForceBackward = 0x31D2314;
	const DWORD dwForceForward = 0x31D22F0;
	const DWORD dwForceJump = 0x524ACB4;
	const DWORD dwForceLeft = 0x31D2308;
	const DWORD dwForceRight = 0x31D2290;
	const DWORD dwGameDir = 0x62D7F8;
	const DWORD dwGameRulesProxy = 0x52BDF9C;
	const DWORD dwGetAllClasses = 0xDB0D6C;
	const DWORD dwGlobalVars = 0x58ECE8;
	const DWORD dwGlowObjectManager = 0x52E9348;
	const DWORD dwInput = 0x51F2338;
	const DWORD dwInterfaceLinkList = 0x945174;
	const DWORD dwLocalPlayer = 0xD892AC;
	const DWORD dwMouseEnable = 0xD8EE50;
	const DWORD dwMouseEnablePtr = 0xD8EE20;
	const DWORD dwPlayerResource = 0x31D0610;
	const DWORD dwRadarBase = 0x51D5ACC;
	const DWORD dwSensitivity = 0xD8ECEC;
	const DWORD dwSensitivityPtr = 0xD8ECC0;
	const DWORD dwSetClanTag = 0x8A1A0;
	const DWORD dwViewMatrix = 0x4D92654;
	const DWORD dwWeaponTable = 0x51F2DF8;
	const DWORD dwWeaponTableIndex = 0x325C;
	const DWORD dwYawPtr = 0xD8EAB0;
	const DWORD dwZoomSensitivityRatioPtr = 0xD93D50;
	const DWORD dwbSendPackets = 0xD73EA;
	const DWORD dwppDirect3DDevice9 = 0xA7050;
	const DWORD find_hud_element = 0x281CE0C0;
	const DWORD force_update_spectator_glow = 0x3AD6E2;
	const DWORD interface_engine_cvar = 0x3E9EC;
	const DWORD is_c4_owner = 0x3BA1C0;
	const DWORD m_bDormant = 0xED;
	const DWORD m_flSpawnTime = 0xA370;
	const DWORD m_pStudioHdr = 0x294C;
	const DWORD m_pitchClassPtr = 0x51D5D68;
	const DWORD m_yawClassPtr = 0xD8EAB0;
	const DWORD model_ambient_min = 0x59205C;
	const DWORD set_abs_angles = 0x1DF810;
	const DWORD set_abs_origin = 0x1DF650;
} // namespace signatures
